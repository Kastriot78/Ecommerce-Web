...
import { getBanners1, deleteBanner1 } from '../../../redux/apiCalls';
...
const ManageBanner1 = () => {
    ...
    const { isDeleted, loading, banners, error } = useSelector((state: RootState) => state.banner1);
    ...
    return (
        <div>
            {loading && <Loader />}
            <DeleteConfirmation show={show} setShow={setShow} deleteFunc={deleteBanner1} id={bannerId} dispatch={dispatch} user={user} />
                                ...
                                <tr key={banner?._id}>
                                    ...
                                    <td data-label="Actions">
                                        <div className='d-flex flex-wrap gap-3'>
                                            <Link to={`/app/admin/add-banner1/${banner?._id}`} className='edit-table-btn'>
