...
export function AddBanner1() {
    ...
    const handleSubmit = (e: any) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if (id) {
                axios.put(`${apiUrl}/banner1/${id}`, formDataObj, { headers: { Authorization: 'Bearer ' + user?.token } }).then(res => {
                    if (res.data.success) {
                        navigate('/app/admin/manage-banners1');
                        setIsLoading(false);
                ...
                axios.post(`${apiUrl}/banner1`, formDataObj, { headers: { Authorization: 'Bearer ' + user?.token } }).then(res => {
                    if (res.data.success) {
    ...
    useEffect(() => {
        if (id) {
            axios.get(`${apiUrl}/banner1/${id}`).then(res => {
        ...
        <div className='add_category'>
            <div className="container_fluid">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                        <div>
                            <span className='mb-3 d-block text-danger'>Please select image size: 1920x500</span>
